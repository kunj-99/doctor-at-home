...
$sql = "SELECT * FROM appointments WHERE doctor_id = ? AND status = 'Pending' ORDER BY appointment_date DESC";
...
while ($row = $result->fetch_assoc()) {
    ...
    // Fetch amount & payment_method from payment_history
    ...
    $appointments[] = [
        ...
        // Vet fields (null for non-vet cases, actual values for vet)
